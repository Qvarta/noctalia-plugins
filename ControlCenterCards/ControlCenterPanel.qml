...
SmartPanel {
  ...
  preferredHeight: {
    ...
    for (var i = 0; i < Settings.data.controlCenter.cards.length; i++) {
      ...
      case "sysmonitor-card":
        ...
        break;
      case "weather-vertical-card":
        height += weatherVerticalHeight;
        break;
      default:
        break;
      }
  ...
  readonly property int sysMonitorHeight: Math.round(170 * Style.uiScaleRatio)
  readonly property int weatherVerticalHeight: Math.round(310 * Style.uiScaleRatio)
