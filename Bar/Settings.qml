  ...
  */
  ...
  JsonAdapter {
    ...
    property JsonObject bar: JsonObject {
      ...
      // Bar width settings
      property string barWidthMode: "full"  // "full", "fixed", "percent"
      property int barFixedWidth: 1200
      property int barPercentWidth: 70
      property bool centerBarHorizontally: true
